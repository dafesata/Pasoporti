...
public class HistorialActivity extends AppCompatActivity {
    ...
    private LinearLayout layoutIdentificacion,layoutTipoId,layoutAcompanado,layoutInfoAcompanado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Tipo=j.getStringExtra("Tipo");
        ...
        layoutAcompanado=(LinearLayout) findViewById(R.id.Layout_acompanado_historial);
        layoutInfoAcompanado=(LinearLayout) findViewById(R.id.Layout_info_historial);

        if(Tipo.equals("Acompanante")){
            layoutAcompanado.setVisibility(View.GONE);
            layoutInfoAcompanado.setVisibility(View.GONE);

            AQuery=mServiciosReference.orderByChild("Acompanante/" + mAuth.getCurrentUser().getUid()).equalTo(true);

            serviciosList[0] = new ArrayList<>();
            mCustomAdapterHistorial[0] = new CustomAdapterHistorial(AQuery, Servicio.class, serviciosList[0], mAdapterKeys, Hacompanado);
